                ...
                md:w-[60%]">
                    ...
                    <div className="bg-zinc-900 rounded-xl outline outline-zinc-800">
                        ...
                        <div className="end-to-end text-xs px-6 py-3">
                            ...
                            <p className="text-sm text-start md:text-end">{exerciseDetails.difficulty}</p>
                        </div>
                        <div className="end-to-end text-xs px-6 py-3">
                            <h4 className="font-bold text-start text-gray-400">Sets</h4>
                            <p className="text-sm text-start md:text-end">{exerciseDetails.sets}</p>
                        </div>
                        <div className="end-to-end text-xs px-6 py-3">
                            <h4 className="font-bold text-start text-gray-400">Reps</h4>
                            <p className="text-sm text-start md:text-end">{exerciseDetails.reps}</p>
                        </div>
                        <div className="end-to-end text-xs px-6 py-3">
                            <h4 className="font-bold text-start text-gray-400">Duration</h4>
                            <p className="text-sm text-start md:text-end">{exerciseDetails.duration} min</p>
                        </div>
                        <div className="end-to-end text-xs px-6 py-3">
                            <h4 className="font-bold text-start text-gray-400">Calories</h4>
                            <p className="text-sm text-start md:text-end">{exerciseDetails.caloriesBurned} kcal</p>
                        </div>

                        <div className="end-to-end border-none text-xs px-6 py-3">
                            <h4 className="font-bold text-start text-gray-400">Rating</h4>
                            <p className="text-sm text-start md:text-end">{exerciseDetails.rating}</p>
                        </div>
                    </div>
